                        ...
                        <tr>
                            ...
                            <td>
                                <code>
                                    ...
                                    for ($i = 0; $i < 8; $i++) {
                                        ...
                                        print(str_pad(dechex($netaddr[$i]), 4, '0'));
                                    }
                                    ?>
                                </code>
                                <br />
                                <code>
                                    ...
                                    for ($i = 0; $i < 8; $i++) {
                                        ...
                                        print(str_pad(dechex($broadaddr), 4, '0', STR_PAD_LEFT));
                                    }
                                    ?>
                                </code>
                            </td>
                            <td>
                                <code>
                                    ...
                                    for ($i = 0; $i < 8; $i++) {
                                        if ($i !== 0) print(':');
                                        print(str_pad(dechex(V6_MASK[$cidr][$i]), 4, '0'));
                                    }
                                    ?>
                                </code>
                            </td>
